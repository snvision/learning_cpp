...
<br></br>
- [x] 65. Вывод типов: ключевое слово auto
- [x] Глава №4. Итоговый тест
- [Печать информации о монстре](https://github.com/snvision/learning_cpp/tree/master/monstersHealth)
<br></br>
- [x] 66. Операторы управления потоком выполнения
программ
...
<br></br>
- [x] 73. Операторы break и continue
- [x] 74. Генерация случайных чисел
- [x] 75. Обработка некорректного пользовательского
ввода
- [Калькулятор с обработкой некорректного пользовательского ввода](https://github.com/snvision/learning_cpp/tree/master/simpleCalculatorV2.0)
<br></br>
